...
kubectl -n ${RATING_NAMESPACE} delete ratingrulemodels.rating.alterway.fr --all
kubectl -n ${RATING_NAMESPACE} delete ratingruleinstances.rating.alterway.fr --all
kubectl -n ${RATING_NAMESPACE} delete ratedmetrics.rating.alterway.fr --all
kubectl -n ${RATING_NAMESPACE} delete ratingruletemplates.rating.alterway.fr --all
